...
namespace JsonConverterWriter
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(JsonConverterWriterCodeRefactoringProvider)), Shared]
    internal class JsonConverterWriterCodeRefactoringProvider : CodeRefactoringProvider
    {
